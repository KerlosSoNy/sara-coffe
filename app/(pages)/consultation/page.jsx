    ...
    <>
      ...
      <div className="container mt-5 relative">
        <Image
          ...
          alt="Academy Banner"
        />
        <h1 className="absolute md:top-1/3 top-[20%] left-1/2 -translate-x-1/2 -translate-y-1/3 text-center text-[32px] text-white font-arialfont-black md:text-[62px]">
          Consultation
        </h1>
        <div className="font-arialfont-medium text-[18px] md:text-[24px] text-[#38503C] text-center px-5 md:px-10 mt-10 md:mt-20">
          <p>
